...
type ChartTooltipContentProps = {
  ...
  formatter?: (value: unknown, name: unknown, item: PayloadItem, index: number, payload: Record<string, unknown>) => React.ReactNode;
  color?: string;
  nameKey?: string;
  labelKey?: string;
};
                  ...
                  >
                    ...
                    {item.value && (
                      <span className="text-foreground font-mono font-medium tabular-nums">
                        {typeof item.value === 'number' || typeof item.value === 'string' ? item.value.toLocaleString() : item.value}
                      </span>
                    )}
                  </div>
                </>
