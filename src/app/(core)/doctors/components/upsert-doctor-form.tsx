        ...
        <DialogContent>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="max-h-[60vh] overflow-y-auto flex flex-col gap-6 pr-2">
                        {/* Name */}
                        <FormField
                        ...
                        <TimeSelectField label="Horário inicial de disponibilidade" name="availableFromTime" control={form.control} />

                        <TimeSelectField label="Horário final de disponibilidade" name="availableToTime" control={form.control} />
